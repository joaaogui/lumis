        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p>Revitalize sua pele com nossos tratamentos faciais luxuosos projetados para nutrir e refrescar seu semblante.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-4">Contorno Corporal</h3>
              <p>Alcance a forma corporal desejada com nossas soluções avançadas de contorno corporal que esculpem e tonificam.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-4">Remoção de Pelos</h3>
              <p>Experimente uma pele suave e livre de pelos com nossos tratamentos de remoção de pelos seguros e eficazes.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="testimonials" className="bg-dark-pink text-white py-12">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row justify-around">
            ...
            <div className="bg-white text-dark-pink p-6 rounded-lg shadow-lg mb-6 md:mb-0 md:w-1/3">
              <p>Estou encantada com os resultados do meu contorno corporal. A equipe foi muito profissional e atenciosa.</p>
              <p className="mt-4 font-semibold">- Jessica T</p>
            </div>
            <div className="bg-white text-dark-pink p-6 rounded-lg shadow-lg md:w-1/3">
              <p>Excelente serviço de remoção de pelos. Me senti confortável e os resultados são fantásticos.</p>
      ...
      <section id="contact" className="py-12">
        <div className="container mx-auto text-center">
          ...
          <form className="bg-white p-8 rounded-lg shadow-lg mx-auto max-w-lg">
            ...
            <label htmlFor="email" className="block text-left mb-4 text-lg font-semibold">Email</label>
            <input type="email" id="email" className="w-full p-3 border border-gray-300 rounded-lg mb-4" required />
            <label htmlFor="message" className="block text-left mb-4 text-lg font-semibold">Mensagem</label>
            <textarea id="message" rows={4} className="w-full p-3 border border-gray-300 rounded-lg mb-4" required></textarea>
            <button type="submit" className="bg-dark-pink text-white py-2 px-6 rounded-lg font-semibold text-lg">Enviar Mensagem</button>
          </form>
        </div>
      </section>
