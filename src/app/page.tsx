export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-6 sm:p-12 lg:p-24 bg-white">
      <header
        className="bg-dark-pink text-dark-pink py-12 "
        style={{
          width: "100%",
          textAlign: "left",
          height: "400px",
      ...
      >
        <div>
          <div className="container mx-auto text-center">
            ...
            <a
              href="#contact"
              className="bg-white text-dark-pink py-2 px-6 rounded-lg font-semibold text-lg"
            >
              Agende uma Consulta
            </a>
          </div>
      ...
      <section id="services" className="py-12">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-semibold mb-8 text-dark-pink">
            Nossos Serviços
          </h2>
      ...
      <section id="contact" className="py-12">
        <div className="container mx-auto text-center">
          ...
          <form className="bg-white p-8 rounded-lg shadow-lg mx-auto max-w-lg">
            ...
            <button
              type="submit"
              className="bg-dark-pink text-white py-2 px-6 rounded-lg font-semibold text-lg"
            >
              Enviar Mensagem
            </button>
          </form>
