...
export const About = () => {
  return (
    <section id="mission-values-vision" className="p-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p>
              ...
              versão,cobrindo níveis físicos e psicológicos
            </p>
            <p>
              Oferecendo tratamentos de saúde e beleza de alta alta qualidade
              executados por profissionais treinados e qualificados com toda a
              dedicação que você merecem.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p>
              ...
              responsabilidade são norteados no nosso atendimento.
            </p>
            <p>
              A excelência no atendimento, treinamentos constantes, inovações
              nos procedimentos, nos faz garantir a segurança e satisfação dos
              nossos clientes.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p>
              ...
              autoestima que habitam em cada um.
            </p>
            <p>
              Possibilitando o desenvolvimento do amor próprio, cuidado com a
              aparência e, sobretudo, o bem-estar e saúde.
            </p>
          </div>
        </div>
      </div>
